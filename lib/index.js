...
SetsFlow.prototype.thenBuild = function () {
    return this._buildPromises.then.apply(this._buildPromises, arguments);
};

SetsFlow.prototype.thenRun = function () {
    return this._runPromise.then.apply(this._runPromise, arguments);
};
